...
function LoginScreen({ onLogin, isLoading, loginError }) {
  ...
  const canRetry = Boolean(name.trim() && mobile.trim());
  const showRetry = /server unreachable/i.test(String(loginError || ''));
          ...
          <View style={styles.panel}>
            ...
            <View style={styles.formCard}>
              ...
              <Pressable
                ...
                accessibilityLabel="Login to dashboard"
              >
                {isLoading ? (
              ...
              {showRetry ? (
                <Pressable
                  style={[styles.secondaryButton, (!canRetry || isLoading) ? styles.buttonDisabled : null]}
                  onPress={handleStart}
